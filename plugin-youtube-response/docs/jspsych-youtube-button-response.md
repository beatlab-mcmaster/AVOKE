...
```js
<script src="https://unpkg.com/@jspsych-contrib/plugin-youtube-response"></script>
```

Using the JavaScript file downloaded from a GitHub release dist archive:

```js
<script src="jspsych/plugin-youtube-response.js"></script>
```

Using NPM:

```
npm install @jspsych-contrib/plugin-youtube-response
```

```js
import {jsPsychYouTubeResponse} from '@jspsych-contrib/plugin-youtube-response';
``` -->
