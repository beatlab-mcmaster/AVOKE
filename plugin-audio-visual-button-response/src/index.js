  ...
  class AudioVisualButtonResponsePlugin {
    ...
    async trial(display_element, trial, on_load) {
      ...
      if (trial.render_on_canvas) {
        ...
        parentDiv.insertBefore(btngroup_div, canvas.nextElementSibling);
      ...
      function disable_buttons() {
        let btns = document.querySelectorAll(".jspsych-av-button-response-button");
      ...
      function enable_buttons() {
        let btns = document.querySelectorAll(".jspsych-av-button-response-button");
        for (let i = 0; i < btns.length; i++) {
          let btn_el = btns[i].querySelector("button");
          if (btn_el) {
