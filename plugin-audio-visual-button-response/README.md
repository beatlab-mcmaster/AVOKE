...
See [documentation](https://github.com/jspsych/jspsych-contrib/blob/main/packages/plugin-audio-visual-button-response/docs/jspsych-audio-visual-button-response.md)
